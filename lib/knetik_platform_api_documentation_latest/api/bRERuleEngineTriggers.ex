defmodule KnetikPlatformAPIDocumentationLatest.Api.BRERuleEngineTriggers do
  ...
  def get_bre_triggers(filter_system, filter_category, filter_tags, filter_name, filter_search, size, page) do
    method = [method: :get]
    url = [url: "/bre/triggers"]
    query_params = [query: [{:"filterSystem", filter_system}, {:"filterCategory", filter_category}, {:"filterTags", filter_tags}, {:"filterName", filter_name}, {:"filterSearch", filter_search}, {:"size", size}, {:"page", page}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
