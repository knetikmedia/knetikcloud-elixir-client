defmodule KnetikPlatformAPIDocumentationLatest.Api.GamificationAchievements do
  ...
  def get_achievements(filter_tagset, filter_name, filter_hidden, size, page, order, filter_derived) do
    method = [method: :get]
    url = [url: "/achievements"]
    query_params = [query: [{:"filterTagset", filter_tagset}, {:"filterName", filter_name}, {:"filterHidden", filter_hidden}, {:"size", size}, {:"page", page}, {:"order", order}, {:"filterDerived", filter_derived}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
