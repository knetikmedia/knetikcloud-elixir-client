defmodule KnetikPlatformAPIDocumentationLatest.Api.AccessToken do
  ...
  def get_o_auth_token(grant_type, client_id, client_secret, username, password) do
    ...
    header_params = []
    body_params = []
    form_params = [body: Enum.map_join([{:"grant_type", grant_type}, {:"client_id", client_id}, {:"client_secret", client_secret}, {:"username", username}, {:"password", password}], "&", &("#{elem(&1, 0)}=#{elem(&1, 1)}"))]
