defmodule KnetikPlatformAPIDocumentationLatest.Api.Media_Moderation do
  @moduledoc """
  Documentation for KnetikPlatformAPIDocumentationLatest.Api.Media_Moderation.
  """
  ...
  """
  def get_moderation_reports(exclude_resolved, filter_context, filter_context_id, size, page, order) do
    method = [method: :get]
    url = [url: "/moderation/reports"]
    query_params = [query: [{:"exclude_resolved", exclude_resolved}, {:"filter_context", filter_context}, {:"filter_context_id", filter_context_id}, {:"size", size}, {:"page", page}, {:"order", order}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
