defmodule KnetikPlatformAPIDocumentationLatest.Api.CampaignsChallenges do
  ...
  def get_challenges(filter_template, filter_active_campaign) do
    method = [method: :get]
    url = [url: "/challenges"]
    query_params = [query: [{:"filterTemplate", filter_template}, {:"filterActiveCampaign", filter_active_campaign}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
