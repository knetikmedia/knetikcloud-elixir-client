defmodule KnetikPlatformAPIDocumentationLatest.Api.Logs do
  ...
  def get_bre_event_logs(filter_start_date, filter_event_name, size, page, order) do
    method = [method: :get]
    url = [url: "/bre/logs/event-log"]
    query_params = [query: [{:"filterStartDate", filter_start_date}, {:"filterEventName", filter_event_name}, {:"size", size}, {:"page", page}, {:"order", order}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
  ...
  def get_user_logs(filter_user, filter_action_name, size, page) do
    method = [method: :get]
    url = [url: "/audit/logs"]
    query_params = [query: [{:"filterUser", filter_user}, {:"filterActionName", filter_action_name}, {:"size", size}, {:"page", page}]]
    header_params = []
    body_params = []
    form_params = []
    params = query_params ++ header_params ++ body_params ++ form_params
